  ...
  return (
    <header className="h-20 sticky top-0 bg-white z-50">
      <Container className="flex items-center h-full">
        ...
        <div className="flex-1">
          <button className="w-[300px] h-12 border rounded-full flex items-center shadow hover:shadow-md transition-all mx-auto">
            <div className="flex-1 text-left px-6 text-sm font-semibold">
              검색 시작하기
            </div>
